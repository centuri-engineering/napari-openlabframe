# -*- coding: utf-8 -*-
#
# napari-openlabframe documentation build configuration file, created by
...
project = u'napari-openlabframe'
copyright = u'2015, Guillaume Gay'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'napari-openlabframe Documentation',
     [author], 1)
]
